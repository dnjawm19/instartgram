...
import com.example.instartgram.security.UserDetailsServiceImpl;
...
public class JwtUtil {
    ...
    public Boolean refreshTokenValidation(String token) {
        ...
        // DB에 저장한 토큰 비교
        Optional<RefreshToken> refreshToken = refreshTokenRepository.findByAccountUserName(getNicknameFromToken(token));
